    ...
    <script>
            ...
            adminData.users.forEach(user => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        ...
                        <button class="admin-action-btn btn-delete" data-id="${user.id}">Nonaktifkan</button>
                    </td>
                `;
        ...
        function renderBannersTable() {
            ...
            adminData.banners.forEach(banner => {
                ...
                row.innerHTML = `
                    <td><img src="${banner.image}" alt="${banner.title}" style="width: 80px; height: 40px; object-fit: cover;"></td>
                    <td>${banner.title}</td>
            ...
            document.querySelectorAll('.btn-edit').forEach(btn => {
                btn.addEventListener('click', function() {
                    const bannerId = parseInt(this.getAttribute('data-id'));
                    editBanner(bannerId);
                });
            });
        ...
        function saveProduct() {
            ...
            if (currentEditingProductId) {
                ...
                products.push({
                    ...
                    originalPrice,
                    stock,
                    image: image || 'https://via.placeholder.com/200x200/cccccc/999999?text=Produk',
                    description
                });
            ...
            // Also update the main products grid
            renderProducts();
        }
        ...
        function approveProduct(productId) {
            ...
            if (productIndex !== -1) {
                ...
                products.push({
                    ...
                    price: product.price,
                    category: 'lainnya',
                    image: 'https://via.placeholder.com/200x200/cccccc/999999?text=Produk+Baru'
                });
        ...
        function deleteBanner(bannerId) {
            if (confirm('Apakah Anda yakin ingin menghapus banner ini?')) {
                const bannerIndex = adminData.banners.findIndex(b => b.id === bannerId);
                
                if (bannerIndex !== -1) {
                    adminData.banners.splice(bannerIndex, 1);
        ...
        function saveBanner() {
            ...
            // Also update carousel if needed
            if (status === 'active') {
                // Add to carousel if it's active
                carouselItems.push({
                    id: Date.now(),
                    image: image,
                    title: title,
        ...
        function renderOrderSummary() {
            ...
            summaryHTML += `
                ...
                <div class="form-group">
                    ...
                    <textarea id="order-notes" class="form-control" rows="2" placeholder="Contoh: Tolong dikirim sebelum jam 5 sore"></textarea>
                </div>
            `;
